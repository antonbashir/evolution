...
@ffi.Native<ffi.Pointer<test_executor_native> Function(ffi.Bool)>(symbol: 'test_executor_initialize', assetId: 'executor-bindings-test', isLeaf: true)
external ffi.Pointer<test_executor_native> test_executor_initialize(
  bool initialize_memory,
);

@ffi.Native<ffi.Int Function(ffi.Pointer<test_executor_native>)>(symbol: 'test_executor_descriptor', assetId: 'executor-bindings-test', isLeaf: true)
external int test_executor_descriptor(
  ffi.Pointer<test_executor_native> executor,
);

@ffi.Native<ffi.Void Function(ffi.Pointer<test_executor_native>, ffi.Bool)>(symbol: 'test_executor_destroy', assetId: 'executor-bindings-test', isLeaf: true)
external void test_executor_destroy(
  ffi.Pointer<test_executor_native> executor,
  bool initialize_memory,
);
...
@ffi.Native<ffi.Void Function()>(symbol: 'test_call_reset', assetId: 'executor-bindings-test', isLeaf: true)
external void test_call_reset();

@ffi.Native<ffi.Bool Function(ffi.Pointer<test_executor_native>)>(symbol: 'test_call_native_check', assetId: 'executor-bindings-test', isLeaf: true)
...
@ffi.Native<ffi.Void Function(ffi.Pointer<test_executor_native>, ffi.Int32, ffi.UintPtr, ffi.Bool)>(symbol: 'test_call_dart_bool', assetId: 'executor-bindings-test', isLeaf: true)
...
@ffi.Native<ffi.Void Function(ffi.Pointer<test_executor_native>, ffi.Int32, ffi.UintPtr, ffi.Int)>(symbol: 'test_call_dart_int', assetId: 'executor-bindings-test', isLeaf: true)
...
@ffi.Native<ffi.Void Function(ffi.Pointer<test_executor_native>, ffi.Int32, ffi.UintPtr, ffi.Double)>(symbol: 'test_call_dart_double', assetId: 'executor-bindings-test', isLeaf: true)
...
@ffi.Native<ffi.Bool Function(ffi.Int, ffi.Int, ffi.Int)>(symbol: 'test_threading_initialize', assetId: 'executor-bindings-test', isLeaf: true)
...
@ffi.Native<ffi.Void Function(ffi.Pointer<ffi.Int32>, ffi.Int32)>(symbol: 'test_threading_prepare_call_dart_bytes', assetId: 'executor-bindings-test', isLeaf: true)
...
@ffi.Native<ffi.IntPtr Function()>(symbol: 'test_threading_call_native_address_lookup', assetId: 'executor-bindings-test', isLeaf: true)
...
final class executor_native extends ffi.Opaque {}

typedef test_executor_native = executor_native;
