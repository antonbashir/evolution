...
@Native<Int16 Function(Pointer<executor_instance> executor, Int64 callback)>(isLeaf: true)
external int executor_register_on_scheduler(Pointer<executor_instance> executor, int callback);

@Native<Int16 Function(Pointer<executor_instance> executor, Bool stop)>(isLeaf: true)
...
@Native<Int16 Function(Pointer<executor_instance> executor)>(isLeaf: true)
...
@Native<Int16 Function(Pointer<executor_instance> executor, Int32 target_ring_fd, Pointer<executor_task> message)>(isLeaf: true)
external int executor_call_native(Pointer<executor_instance> executor, int target_ring_fd, Pointer<executor_task> message);

@Native<Int16 Function(Pointer<executor_instance> executor, Pointer<executor_task> message)>(isLeaf: true)
...
@Native<Int16 Function(Pointer<io_uring> ring, Int32 source_ring_fd, Int32 target_ring_fd, Pointer<executor_task> message)>(isLeaf: true)
...
@Native<Int16 Function(Pointer<io_uring> ring, Int32 source_ring_fd, Pointer<executor_task> message)>(isLeaf: true)
