#ifndef INTERACTOR_CONFIGURATION_H
#define INTERACTOR_CONFIGURATION_H
...
{
#endif
   struct interactor_module_dart_configuration
    {
        size_t quota_size;
    ...
    struct interactor_module_native_configuration
    {
        uint64_t cqe_wait_timeout_millis;
        size_t quota_size;
        size_t preallocation_size;
