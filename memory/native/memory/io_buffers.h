...
DART_INLINE struct memory_io_buffers* memory_io_buffers_create(struct memory* memory)
{
...
DART_INLINE void memory_io_buffers_destroy(struct memory_io_buffers* pool)
{
...
DART_INLINE struct memory_input_buffer* memory_io_buffers_allocate_input(struct memory_io_buffers* buffers, size_t initial_capacity)
{
...
DART_INLINE void memory_io_buffers_free_input(struct memory_io_buffers* buffers, struct memory_input_buffer* buffer)
{
    ibuf_destroy(&buffer->buffer);
    memory_pool_free(&buffers->input_buffers, buffer);
}

DART_INLINE struct memory_output_buffer* memory_io_buffers_allocate_output(struct memory_io_buffers* buffers, size_t initial_capacity)
{
...
DART_INLINE void memory_io_buffers_free_output(struct memory_io_buffers* buffers, struct memory_output_buffer* buffer)
{
    obuf_destroy(&buffer->buffer);
    memory_pool_free(&buffers->output_buffers, buffer);
}

DART_INLINE uint8_t* memory_input_buffer_reserve(struct memory_input_buffer* buffer, size_t size)
{
...
DART_INLINE uint8_t* memory_input_buffer_finalize(struct memory_input_buffer* buffer, size_t size)
{
...
DART_INLINE uint8_t* memory_input_buffer_finalize_reserve(struct memory_input_buffer* buffer, size_t delta, size_t size)
{
...
DART_INLINE uint8_t* memory_output_buffer_reserve(struct memory_output_buffer* buffer, size_t size)
{
    return obuf_reserve(&buffer->buffer, size ? size : buffer->buffer.start_capacity);
}

DART_INLINE uint8_t* memory_output_buffer_finalize(struct memory_output_buffer* buffer, size_t size)
{
    return obuf_alloc(&buffer->buffer, size);
}

DART_INLINE uint8_t* memory_output_buffer_finalize_reserve(struct memory_output_buffer* buffer, size_t delta, size_t size)
{
