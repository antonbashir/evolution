...
void main(List<String> args) => test("test replica ${args[0]}", () async {
      ...
      final bootConfiguration = StorageDefaults.boot.launchConfiguration;
      final configuration = StorageDefaults.storage.copyWith(
        listen: args[0].toString(),
        replication: StorageReplicationConfiguration()
            .addAddressReplica("127.0.0.1", args[1], user: bootConfiguration.username, password: bootConfiguration.password)
            .addAddressReplica("127.0.0.1", args[2], user: bootConfiguration.username, password: bootConfiguration.password)
            .addAddressReplica("127.0.0.1", args[3], user: bootConfiguration.username, password: bootConfiguration.password)
            .format(),
