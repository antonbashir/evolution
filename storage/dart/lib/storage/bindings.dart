...
@ffi.Native<ffi.Int32 Function()>(symbol: 'tarantool_is_read_only', assetId: 'tarantool-bindings', isLeaf: true)
...
@ffi.Native<ffi.Int32 Function(ffi.Pointer<tarantool_executor_configuration>)>(symbol: 'tarantool_executor_initialize', assetId: 'tarantool-bindings', isLeaf: true)
...
@ffi.Native<ffi.Int32 Function()>(symbol: 'tarantool_executor_descriptor', assetId: 'tarantool-bindings', isLeaf: true)
external int tarantool_executor_descriptor();

@ffi.Native<ffi.Int32 Function(ffi.Pointer<tarantool_factory>, ffi.Pointer<tarantool_factory_configuration>)>(symbol: 'tarantool_factory_initialize', assetId: 'tarantool-bindings', isLeaf: true)
