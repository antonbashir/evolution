...
class StorageFactory {
  ...
  late final MemoryObjects<Pointer<executor_message>> _messages;
  ...
  StorageFactory(MemoryModule memory, this._strings) {
    _messages = memory.structures.register<executor_message>(sizeOf<executor_message>()).asObjectPool();
  ...
  @inline
  Pointer<executor_message> createMessage() => _messages.allocate();

  @inline
  void releaseMessage(Pointer<executor_message> message) => _messages.release(message);

  @inline
  Pointer<executor_message> createSpace(int spaceId, Pointer<Uint8> tuple, int tupleSize) {
  ...
  @inline
  Pointer<executor_message> createSpaceCount(int spaceId, int iteratorType, Pointer<Uint8> key, int keySize) {
  ...
  @inline
  Pointer<executor_message> createSpaceSelect(int spaceId, Pointer<Uint8> key, int keySize, int offset, int limit, int iteratorType) {
  ...
  @inline
  Pointer<executor_message> createSpaceUpdate(int spaceId, Pointer<Uint8> key, int keySize, Pointer<Uint8> operations, int operationsSize) {
  ...
  @inline
  Pointer<executor_message> createSpaceUpsert(int spaceId, Pointer<Uint8> tuple, int tupleSize, Pointer<Uint8> operations, int operationsSize) {
  ...
  @inline
  Pointer<executor_message> createSpaceIterator(int spaceId, int type, Pointer<Uint8> key, int keySize) {
  ...
  @inline
  Pointer<executor_message> createIndex(int spaceId, int indexId, Pointer<Uint8> tuple, int tupleSize) {
  ...
  @inline
  Pointer<executor_message> createIndexCount(int spaceId, int indexId, Pointer<Uint8> key, int keySize, int iteratorType) {
  ...
  @inline
  Pointer<executor_message> createIndexIdByName(int spaceId, String name) {
  ...
  @inline
  Pointer<executor_message> createIndexId(int spaceId, int indexId) {
  ...
  @inline
  Pointer<executor_message> createIndexUpdate(int spaceId, int indexId, Pointer<Uint8> key, int keySize, Pointer<Uint8> operations, int operationsSize) {
  ...
  @inline
  Pointer<executor_message> createCall(String function, Pointer<Uint8> input, int inputSize) {
  ...
  @inline
  Pointer<executor_message> createEvaluate(String expression, Pointer<Uint8> input, int inputSize) {
  ...
  @inline
  Pointer<executor_message> createIndexIterator(int spaceId, int indexId, int type, Pointer<Uint8> key, int keySize) {
  ...
  @inline
  Pointer<executor_message> createIndexSelect(int spaceId, int indexId, Pointer<Uint8> key, int keySize, int offset, int limit, int type) {
  ...
  Pointer<executor_message> createString(String string) {
  ...
  @inline
  void releaseString(Pointer<executor_message> message) {
