...
class LuaField {
  ...
  static String quotedField(String name, String value) => "$name = '$value'";
...
class LuaArgument {
  ...
  static String singleQuotedArgument(String argument, {String? options}) => options != null ? "('$argument', {$options})" : "('$argument')";
