...
@Native<Uint64 Function(Pointer<storage_tuple> tuple, Uint32 field)>(isLeaf: true)
external int storage_tuple_get_uint64(Pointer<storage_tuple> tuple, int field);
