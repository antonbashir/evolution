...
Future<void> testSchema() async {
  ...
  expect(tarantoolCallExtractBool(await _executor.call("validateCreatedSpace")), isTrue);
  ...
  expect(tarantoolCallExtractBool(await _executor.call("validateCreatedIndex")), isTrue);
...
Future<void> testExecuteLua() async {
  ...
  await _executor.file(File("test.lua"));
  File("test.lua").deleteSync();
  expect(tarantoolCallExtractList(await _executor.call("test"), tupleReadString), equals(["test"]));
  expect(tarantoolCallExtractList(await _executor.call("testFile"), tupleReadString), equals(["testFile"]));
}
//
