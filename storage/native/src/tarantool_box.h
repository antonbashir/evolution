...
extern "C"
{
    ...
    {
        void (*tarantool_evaluate_address)(struct executor_message*);
        void (*tarantool_call_address)(struct executor_message*);
        void (*tarantool_iterator_next_single_address)(struct executor_message*);
        void (*tarantool_iterator_next_many_address)(struct executor_message*);
        void (*tarantool_iterator_destroy_address)(struct executor_message*);
        void (*tarantool_free_output_buffer_address)(struct executor_message*);
        void (*tarantool_space_id_by_name_address)(struct executor_message*);
        void (*tarantool_space_count_address)(struct executor_message*);
        void (*tarantool_space_length_address)(struct executor_message*);
        void (*tarantool_space_iterator_address)(struct executor_message*);
        void (*tarantool_space_insert_single_address)(struct executor_message*);
        void (*tarantool_space_insert_many_address)(struct executor_message*);
        void (*tarantool_space_put_single_address)(struct executor_message*);
        void (*tarantool_space_put_many_address)(struct executor_message*);
        void (*tarantool_space_delete_single_address)(struct executor_message*);
        void (*tarantool_space_delete_many_address)(struct executor_message*);
        void (*tarantool_space_update_single_address)(struct executor_message*);
        void (*tarantool_space_update_many_address)(struct executor_message*);
        void (*tarantool_space_get_address)(struct executor_message*);
        void (*tarantool_space_min_address)(struct executor_message*);
        void (*tarantool_space_max_address)(struct executor_message*);
        void (*tarantool_space_truncate_address)(struct executor_message*);
        void (*tarantool_space_upsert_address)(struct executor_message*);
        void (*tarantool_index_count_address)(struct executor_message*);
        void (*tarantool_index_length_address)(struct executor_message*);
        void (*tarantool_index_iterator_address)(struct executor_message*);
        void (*tarantool_index_get_address)(struct executor_message*);
        void (*tarantool_index_max_address)(struct executor_message*);
        void (*tarantool_index_min_address)(struct executor_message*);
        void (*tarantool_index_update_single_address)(struct executor_message*);
        void (*tarantool_index_update_many_address)(struct executor_message*);
        void (*tarantool_index_select_address)(struct executor_message*);
        void (*tarantool_index_id_by_name_address)(struct executor_message*);
    };
    ...
    struct tarantool_space_request
    {
        ...
        const uint8_t* tuple;
        uint32_t space_id;
        struct executor_message message;
    };
