...
@ffi.Native<
        ffi.Int32 Function(ffi.Pointer<transport>,
...
@ffi.Native<
        ffi.Int32 Function(
            ffi.Pointer<transport>, ffi.Pointer<mediator.mediator_dart>)>(
    symbol: 'transport_setup', assetId: 'transport-bindings', isLeaf: true)
external int transport_setup(
  ffi.Pointer<transport> transport,
  ffi.Pointer<mediator.mediator_dart> mediator,
);
...
@ffi.Native<
        ffi.Void Function(ffi.Pointer<transport>, ffi.Uint32, ffi.Uint16,
            ffi.Int32, ffi.Int32, ffi.Int64, ffi.Uint16, ffi.Uint8)>(
...
@ffi.Native<ffi.Void Function(ffi.Pointer<transport>, ffi.Int32)>(
...
@ffi.Native<
        ffi.Pointer<sockaddr> Function(
            ffi.Pointer<transport>, ffi.Int32, ffi.Int32)>(
...
@ffi.Native<
        ffi.Int32 Function(
            ffi.Pointer<ffi.Char>, ffi.Int32, ffi.Bool, ffi.Bool)>(
...
final class transport_configuration extends ffi.Struct {
  external memory.memory_module_configuration memory_configuration;

  external mediator.mediator_dart_configuration mediator_configuration;
...
final class transport extends ffi.Struct {
  ...
  external ffi.Pointer<mediator.mediator_dart> transport_mediator;
