...
class Transport {
  ...
  int get descriptor => _mediator.descriptor;
  ...
  Future<void> initialize() async {
    ...
    _mediator = Mediator(configuration[2] as SendPort);
    _fromTransport.close();
    await _mediator.initialize(processor: _process);
    ...
    final result = transport_setup(_pointer, _mediator.pointer);
    if (result != 0) {
