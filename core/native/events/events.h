...
#define event_new_trace_stamp() event_build(MODULE_EVENT_LEVEL_TRACE, __FUNCTION__, __FILENAME__, __LINE__, "", 0)
#define event_new_information_stamp() event_build(MODULE_EVENT_LEVEL_INFORMATION, __FUNCTION__, __FILENAME__, __LINE__, "", 0)
#define event_new_warning_stamp() event_build(MODULE_EVENT_LEVEL_WARNING, __FUNCTION__, __FILENAME__, __LINE__, "", 0)
#define event_new_error_stamp() event_build(MODULE_EVENT_LEVEL_ERROR, __FUNCTION__, __FILENAME__, __LINE__, "", 0)
#define event_new_panic_stamp() event_build(MODULE_EVENT_LEVEL_PANIC, __FUNCTION__, __FILENAME__, __LINE__, "", 0)
