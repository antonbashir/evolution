...
void fragmentation() {
  ...
  test(
    '1 simple request -> 1 fragmented request',
    timeout: Timeout(Duration(seconds: 60)),
    () => runTest(() async {
      final transport = context().transport();
  ...
  test(
    '1 simple request -> 1 fragmented request -> 1 simple request',
    timeout: Timeout(Duration(seconds: 60)),
    () => runTest(() async {
      final transport = context().transport();
  ...
  test(
    '1 simple request -> 1 fragmented request -> 1 simple request -> 1 fragmented request',
    timeout: Timeout(Duration(seconds: 60)),
    () => runTest(() async {
      final transport = context().transport();
